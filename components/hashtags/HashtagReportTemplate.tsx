...
import { Camera, Edit3, Heart, MessageSquare, Check, Copy, Sparkles, ArrowRight } from "lucide-react";
...
export function HashtagReportTemplate({ data, relatedSlugs = [] }: HashtagReportTemplateProps) {
  ...
  return (
    <article className="w-full max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-10 text-left">
      ...
      {/* 1. Header (Exact match to Image 1) */}
      ...
      {/* 2. Primary Hashtag Box (Exact match to Image 1) */}
      ...
      {/* 3. Secondary Hashtag Box (Exact match to Image 1) */}
